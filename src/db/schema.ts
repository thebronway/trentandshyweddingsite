...
export const guests = pgTable('guests', {
  ...
  p1Name: text('p1_name'),
  p1LastName: text('p1_last_name'),
  p1Email: text('p1_email'),
  p1PhoneNumber: text('p1_phone_number'),
  p1Role: text('p1_role').default('guest').notNull(),
  ...
  p2Name: text('p2_name'),
  p2LastName: text('p2_last_name'),
  p2Email: text('p2_email'),
  p2PhoneNumber: text('p2_phone_number'),
  p2Role: text('p2_role').default('guest').notNull(),
  ...
  p3Name: text('p3_name'),
  p3LastName: text('p3_last_name'),
  p3Email: text('p3_email'),
  p3PhoneNumber: text('p3_phone_number'),
  p3Role: text('p3_role').default('guest').notNull(),
